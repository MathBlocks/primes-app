...
export const Community: FC = () => (
  <Container>
    <h1>MathBlocks Community</h1>
    <p>
      We are a community whose mission is to facilitate the creation
      of{' '}
    ...
    <p>
      ...
      the MathBlocks Treasury, which is then used to support our
    ...
    <ul>
      ...
      <li>
        ...
        of sale and/or resale fees are donated to the Treasury. The
        collection then gets promoted by MathBlocks.
      </li>
      <li>
    ...
    <p>
      Primes are used to govern MathBlocks, namely vote in proposals
      on <a href="https://vote.mathblocks.io">our Snapshot</a>. All
      Primes have equal voting power.
    </p>
    {/* <p>
    ...
    <h4>Beneficiaries</h4>
    <p>
      As stated before, MathBlocks facilitates the creation of
